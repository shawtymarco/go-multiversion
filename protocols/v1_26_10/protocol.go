// Package v1_26_10 implements the Minecraft Bedrock 1.26.1x protocol 944
...
const (
	// ID is the Minecraft Bedrock 1.26.1x protocol ID.
	ID int32 = 944
	// Version is the newest stable Minecraft version in the protocol 944 family.
	Version = "1.26.14"
)

// Protocol implements minecraft.Protocol for stable Minecraft 1.26.10
// through 1.26.14.
...
// a configured protocol-944 adapter.
...
// New creates a protocol 944 wire adapter.
func New() minecraft.Protocol { return &Protocol{} }

// NewWithBlockRegistry creates a fully configured protocol-944 adapter using
...
// MapBlockRuntimeID maps a current native runtime ID to the protocol-944
...
func (Protocol) Packets(listener bool) packet.Pool {
	...
	// Protocol 944 left packet ID 16 unused. UpdateBlock was not accepted as
