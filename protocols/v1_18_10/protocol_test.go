...
func TestHistoricalPacketOracles(t *testing.T) {
	...
	fixtures := map[string]oracleFixture{
		...
		"update_block":             {packet: &packet.UpdateBlock{Position: protocol.BlockPos{1, 64, -2}, NewBlockRuntimeID: 9, Flags: packet.BlockUpdateNetwork}, hex: "024003090200"},
		"update_block_synced":      {packet: &packet.UpdateBlockSynced{Position: protocol.BlockPos{1, 64, -2}, NewBlockRuntimeID: 9, Flags: packet.BlockUpdateNetwork, EntityUniqueID: ^uint64(4), TransitionType: packet.EntityToBlockTransition}, hex: "0240030902000902"},
