...
func wireFixtures() []packetFixture {
	return []packetFixture{
		...
		{name: "actor_event", new: func() packet.Packet { return &packet.ActorEvent{EntityRuntimeID: 1, EventType: packet.ActorEventHurt} }},
		...
		{name: "camera_instruction", new: func() packet.Packet {
			return &packet.CameraInstruction{
				FieldOfView: protocol.Option(protocol.CameraInstructionFieldOfView{FieldOfView: 80, EaseTime: 1, EaseType: protocol.EasingTypeInQuad}),
				Spline:      protocol.Option(protocol.CameraSplineInstruction{TotalTime: 2, SplineType: protocol.Option(uint8(1)), Curve: []mgl32.Vec3{{1, 2, 3}}, ProgressKeyFrames: []protocol.CameraProgressOption{{Value: 1, Time: 2, EaseType: protocol.EasingTypeOutQuad}}, RotationOptions: []protocol.CameraRotationOption{{Value: mgl32.Vec3{4, 5, 6}, Time: 3, EaseType: protocol.EasingTypeInOutQuad}}}),
			}
		}},
		{name: "camera_spline", new: func() packet.Packet {
			return &packet.CameraSpline{Splines: []protocol.CameraSplineDefinition{{Name: "path", TotalTime: 2, SplineType: protocol.Option(protocol.SplineTypeLinear), ControlPoints: []mgl32.Vec3{{1, 2, 3}}, ProgressKeyFrames: []protocol.CameraProgressOption{{Value: 1, Time: 2}}, RotationKeyFrames: []protocol.CameraRotationOption{{Value: mgl32.Vec3{4, 5, 6}, Time: 3}}}}}
		}},
		{name: "client_bound_data_driven_ui_close_screen", new: func() packet.Packet {
			return &packet.ClientBoundDataDrivenUICloseScreen{}
		}},
		{name: "client_bound_data_driven_ui_show_screen", new: func() packet.Packet {
			return &packet.ClientBoundDataDrivenUIShowScreen{ScreenID: "screen", FormID: 4, DataInstanceID: protocol.Option(uint32(5))}
		}},
		...
		{name: "player_enchant_options", new: func() packet.Packet { return &packet.PlayerEnchantOptions{} }},
		...
		{name: "update_client_options", listener: true, new: func() packet.Packet { return &packet.UpdateClientOptions{GraphicsMode: protocol.Option(byte(1))} }},
		{name: "update_client_input_locks", new: func() packet.Packet {
			return &packet.UpdateClientInputLocks{Locks: packet.ClientInputLockCamera | packet.ClientInputLockMovement}
		}},
		{name: "voxel_shapes", new: func() packet.Packet {
			return &packet.VoxelShapes{Shapes: []protocol.VoxelShape{{Cells: protocol.VoxelCells{XSize: 1, YSize: 1, ZSize: 1, Storage: []uint8{1}}, XCoordinates: []float32{0, 1}, YCoordinates: []float32{0, 1}, ZCoordinates: []float32{0, 1}}}, NameMap: []protocol.VoxelShapeNameEntry{{Name: "cube", ID: 1}}, CustomShapeCount: 1}
		}},
		{name: "full/text", new: func() packet.Packet {
			return &packet.Text{TextType: packet.TextTypeRaw, Message: "message"}
		}},
		{name: "full/add_volume_entity", new: func() packet.Packet {
			return &packet.AddVolumeEntity{EntityRuntimeID: 1, EntityMetadata: map[string]any{"name": "volume"}, EncodingIdentifier: "test:volume", InstanceIdentifier: "fog", Bounds: [2]protocol.BlockPos{{1, 2, 3}, {4, 5, 6}}, Dimension: 0, EngineVersion: "1.26.0"}
		}},
		{name: "full/anvil_damage", listener: true, new: func() packet.Packet {
			return &packet.AnvilDamage{AnvilPosition: protocol.BlockPos{1, 64, 2}}
		}},
		{name: "full/block_actor_data", new: func() packet.Packet {
			return &packet.BlockActorData{Position: protocol.BlockPos{1, 64, 2}, NBTData: map[string]any{"id": "Chest"}}
		}},
		{name: "full/block_event", new: func() packet.Packet {
			return &packet.BlockEvent{Position: protocol.BlockPos{1, 64, 2}, EventType: 1, EventData: 2}
		}},
		{name: "full/command_block_update", listener: true, new: func() packet.Packet {
			return &packet.CommandBlockUpdate{Block: true, Position: protocol.BlockPos{1, 64, 2}, Mode: packet.CommandBlockImpulse, Command: "say hi", Name: "command", ShouldTrackOutput: true}
		}},
		{name: "full/container_open", new: func() packet.Packet {
			return &packet.ContainerOpen{WindowID: 1, ContainerType: 2, ContainerPosition: protocol.BlockPos{1, 64, 2}, ContainerEntityUniqueID: 3}
		}},
		{name: "full/actor_event", new: func() packet.Packet {
			return &packet.ActorEvent{EntityRuntimeID: 1, EventType: packet.ActorEventHurt, EventData: -2, FireAtPosition: protocol.Option(mgl32.Vec3{3, 4, 5})}
		}},
		...
		{name: "full/client_movement_prediction_sync", new: func() packet.Packet {
			flags := protocol.NewBitset(protocol.EntityDataFlagUsesLegacyFriction)
			flags.Set(1)
			return &packet.ClientMovementPredictionSync{ActorFlags: flags, BoundingBoxScale: 1, MovementSpeed: 2, FrictionModifier: 3, Bounciness: 4, AirDragModifier: 5, EntityUniqueID: 3, Flying: true}
		}},
		...
		{name: "full/client_bound_map_item_data", new: func() packet.Packet {
			return &packet.ClientBoundMapItemData{
				...
				TrackedObjects: protocol.Option([]protocol.MapTrackedObject{{Type: protocol.MapObjectTypeEntity, EntityUniqueID: protocol.Option(int64(9))}, {Type: protocol.MapObjectTypeBlock, BlockPosition: protocol.Option(protocol.BlockPos{1, 64, 2})}}),
		...
		{name: "full/inventory_slot", new: func() packet.Packet {
			return &packet.InventorySlot{WindowID: 1, Slot: 2, Container: protocol.Option(protocol.FullContainerName{ContainerID: 3}), StorageItem: protocol.Option(itemInstance(4)), NewItem: itemInstance(5)}
		}},
		...
		{name: "full/mob_equipment", new: func() packet.Packet {
			return &packet.MobEquipment{EntityRuntimeID: 1, NewItem: itemInstance(5), InventorySlot: 2, HotBarSlot: 3, WindowID: 4}
		}},
		{name: "full/lectern_update", listener: true, new: func() packet.Packet {
			return &packet.LecternUpdate{Page: 1, PageCount: 2, Position: protocol.BlockPos{1, 64, 2}}
		}},
		{name: "full/move_actor_absolute", new: func() packet.Packet {
			return &packet.MoveActorAbsolute{EntityRuntimeID: 1, Flags: packet.MoveFlagOnGround | packet.MoveFlagForceMove}
		}},
		...
		{name: "full/play_sound", new: func() packet.Packet {
			return &packet.PlaySound{SoundName: "note.harp", Position: mgl32.Vec3{1, 2, 3}, Volume: 1, Pitch: 1, Handle: protocol.Option(uint64(9))}
		}},
		...
		{name: "full/player_action", listener: true, new: func() packet.Packet {
			return &packet.PlayerAction{EntityRuntimeID: 1, ActionType: protocol.PlayerActionStartBreak, BlockPosition: protocol.BlockPos{1, 64, 2}, ResultPosition: protocol.BlockPos{1, 65, 2}, BlockFace: 1}
		}},
		{name: "full/open_sign", new: func() packet.Packet {
			return &packet.OpenSign{Position: protocol.BlockPos{1, 64, 2}, FrontSide: true}
		}},
		...
		{name: "full/player_enchant_options", new: func() packet.Packet {
			return &packet.PlayerEnchantOptions{Options: []protocol.EnchantmentOption{{Cost: 30, Name: "option", RecipeNetworkID: 7}}}
		}},
		...
		{name: "full/server_bound_diagnostics", new: func() packet.Packet {
			return &packet.ServerBoundDiagnostics{AverageFramesPerSecond: 60, AverageRenderTime: 1.5, EntityDiagnostics: []protocol.EntityDiagnosticTimingInfo{{DisplayName: "pig", Entity: "minecraft:pig", DurationNanos: 1}}}
		}},
		...
		{name: "full/set_spawn_position", new: func() packet.Packet {
			return &packet.SetSpawnPosition{SpawnType: packet.SpawnTypeWorld, Position: protocol.BlockPos{1, 64, 2}, Dimension: 0, SpawnPosition: protocol.BlockPos{3, 65, 4}}
		}},
		{name: "full/structure_template_data_request", listener: true, new: func() packet.Packet {
			return &packet.StructureTemplateDataRequest{StructureName: "test", Position: protocol.BlockPos{1, 64, 2}, Settings: protocol.StructureSettings{PaletteName: "default", Size: protocol.BlockPos{3, 4, 5}, Offset: protocol.BlockPos{1, 2, 3}, Integrity: 1}, RequestType: packet.StructureTemplateRequestQuerySavedStructure}
		}},
		{name: "full/update_block", new: func() packet.Packet {
			return &packet.UpdateBlock{Position: protocol.BlockPos{1, 64, 2}, NewBlockRuntimeID: 3, Flags: packet.BlockUpdateNetwork, Layer: 0}
		}},
		{name: "full/update_block_synced", new: func() packet.Packet {
			return &packet.UpdateBlockSynced{Position: protocol.BlockPos{1, 64, 2}, NewBlockRuntimeID: 3, Flags: packet.BlockUpdateNetwork, EntityUniqueID: 4, TransitionType: packet.BlockToEntityTransition}
		}},
		{name: "full/update_sub_chunk_blocks", new: func() packet.Packet {
			return &packet.UpdateSubChunkBlocks{Position: protocol.BlockPos{1, 64, 2}, Blocks: []protocol.BlockChangeEntry{{BlockPos: protocol.BlockPos{1, 65, 2}, BlockRuntimeID: 3, Flags: packet.BlockUpdateNetwork, SyncedUpdateEntityUniqueID: 4, SyncedUpdateType: packet.BlockToEntityTransition}}}
		}},
		{name: "full/start_game", new: func() packet.Packet {
			return &packet.StartGame{EntityUniqueID: 1, EntityRuntimeID: 2, WorldSeed: 3, PlayerPermissions: 2,
				...
				ServerJoinInformation: protocol.Option(protocol.ServerJoinInformation{
					GatheringJoinInfo: protocol.Option(protocol.GatheringJoinInfo{
						ExperienceID: uuid.MustParse("11111111-2222-3333-4444-555555555555"), ExperienceName: "experience",
						ExperienceWorldID: protocol.Option(uuid.MustParse("aaaaaaaa-bbbb-cccc-dddd-eeeeeeeeeeee")), ExperienceWorldName: protocol.Option("world"), CreatorID: "creator",
						TargetID: protocol.Option(uuid.MustParse("99999999-8888-7777-6666-555555555555")), ScenarioID: protocol.Option("scenario"), ServerID: protocol.Option("server"),
					}),
					PresenceInfo: protocol.Option(protocol.PresenceInfo{RichPresenceID: protocol.Option("rich")}),
				}),
			}
		}},
		{name: "full/primitive_text", new: func() packet.Packet {
			return &packet.PrimitiveShapes{Shapes: []protocol.PrimitiveShape{{NetworkID: 1, Type: protocol.Option(uint8(protocol.PrimitiveShapeText)), MaxRenderDistance: protocol.Option(float32(64)), ExtraShapeData: &protocol.TextShape{Text: "label", UseRotation: true, DepthTest: true}}}}
		}},
		...
		{name: "full/update_client_options", listener: true, new: func() packet.Packet {
			return &packet.UpdateClientOptions{GraphicsMode: protocol.Option(byte(2)), FilterProfanity: protocol.Option(true)}
		}},
	}
}
...
func TestProtocolIdentityAndPools(t *testing.T) {
	...
	if got, want := protocolVersion.ID(), int32(924); got != want {
		t.Fatalf("protocol ID: got %d, want %d", got, want)
	}
	if got, want := protocolVersion.Ver(), "1.26.3"; got != want {
		t.Fatalf("version: got %q, want %q", got, want)
	}
	if _, ok := protocolVersion.Packets(false)[packet.IDServerPlayerPostMovePosition]; ok {
		t.Fatal("ServerPlayerPostMovePosition is present in protocol 924 server pool")
	}
	if _, ok := protocolVersion.Packets(true)[packet.IDUpdateBlock]; ok {
		t.Fatal("UpdateBlock is present in protocol 924 client pool")
	}
	for _, id := range []uint32{
		packet.IDClientboundUpdateSoundData, packet.IDSendPartyDestinationCookie, packet.IDPartyDestinationCookieResponse,
		packet.IDServerStoreInfo, packet.IDServerPresenceInfo, packet.IDClientBoundDataStore, packet.IDServerBoundDataStore,
		packet.IDResourcePacksReadyForValidation, packet.IDLocatorBar, packet.IDPartyChanged,
		packet.IDServerBoundDataDrivenScreenClosed, packet.IDSyncWorldClocks, packet.IDClientBoundAttributeLayerSync,
	} {
		if _, ok := protocolVersion.Packets(false)[id]; ok {
			t.Fatalf("post-924 packet ID %d is present in protocol 924 server pool", id)
		}
		if _, ok := protocolVersion.Packets(true)[id]; ok {
			t.Fatalf("post-924 packet ID %d is present in protocol 924 client pool", id)
		}
	}
}
...
func TestHistoricalGophertunnelOracle(t *testing.T) {
	oracle := os.Getenv("V924_WIRE_ORACLE")
	if oracle == "" {
		t.Skip("V924_WIRE_ORACLE is not set")
	}
	for _, fixture := range wireFixtures() {
		t.Run(fixture.name, func(t *testing.T) {
			pk := fixture.new()
	...
	for _, direction := range []struct {
		...
		t.Run(direction.name, func(t *testing.T) {
			...
			for _, rawID := range ids {
				...
				output, err := command.CombinedOutput()
				if err != nil {
					failures = append(failures, strconv.Itoa(rawID)+"="+reflect.TypeOf(pk).String()+": "+strings.TrimSpace(string(output)))
					continue
				}
				decoded, err := hex.DecodeString(string(output))
				if err != nil || !bytes.Equal(decoded, encoded) {
					failures = append(failures, strconv.Itoa(rawID)+"="+reflect.TypeOf(pk).String()+": historical re-encode differs input="+hex.EncodeToString(encoded)+" output="+strings.TrimSpace(string(output)))
				}
			}
			if len(failures) != 0 {
...
func TestUnsupportedFieldsAreFilteredWithoutMutation(t *testing.T) {
	...
	filteredShapes := convertedShapes[0].(*translatedPacket).inner.(*packet.PrimitiveShapes)
...
func TestPost924SoundIsDropped(t *testing.T) {
	if got := (Protocol{}).ConvertFromLatest(&packet.LevelSoundEvent{SoundType: packet.SoundEventPushedByPlayer}, nil); len(got) != 0 {
		t.Fatalf("post-924 sound conversion count: got %d, want 0", len(got))
	}
}
