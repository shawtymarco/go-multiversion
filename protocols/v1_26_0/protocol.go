// Package v1_26_0 implements the Minecraft Bedrock 1.26.0-1.26.3 protocol 924
...
const (
	// ID is the Minecraft Bedrock 1.26.0x protocol ID.
	ID int32 = 924
	// Version is the newest stable Minecraft version in the protocol 924 family.
	Version = "1.26.3"
)

// Protocol implements minecraft.Protocol for stable Minecraft 1.26.0 through
// 1.26.3.
...
// a configured protocol-924 adapter.
...
// New creates a protocol 924 wire adapter.
func New() minecraft.Protocol { return &Protocol{} }

// NewWithBlockRegistry creates a fully configured protocol-924 adapter using
...
// MapBlockRuntimeID maps a current native runtime ID to the protocol-924
...
func (Protocol) Packets(listener bool) packet.Pool {
	...
	// Protocol 924 left packet ID 16 unused. UpdateBlock was not accepted as
