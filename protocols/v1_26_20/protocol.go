// Package v1_26_20 implements the Minecraft Bedrock 1.26.2x protocol 975
...
const (
	// ID is the Minecraft Bedrock 1.26.2x protocol ID.
	ID int32 = 975
	// Version is the newest stable Minecraft version in the protocol 975 family.
	Version = "1.26.23"
)

// Protocol implements minecraft.Protocol for stable Minecraft 1.26.20,
// 1.26.21, and 1.26.23. It is intentionally not included in
// multiversion.Protocols until registry and chunk conversion are complete.
type Protocol struct {
	runtime *runtimeData
}

// MappingReport summarises the exact registries and explicit fallbacks used by
// a configured protocol-975 adapter.
...
// New creates a protocol 975 wire adapter.
func New() minecraft.Protocol { return &Protocol{} }

// NewWithBlockRegistry creates a fully configured protocol-975 adapter using
...
// MapBlockRuntimeID maps a current native runtime ID to the protocol-975
...
func (Protocol) Packets(listener bool) packet.Pool {
	...
	// Protocol 975 left packet ID 16 unused. UpdateBlock was not accepted as
