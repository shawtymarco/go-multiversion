...
func marshalBlockChangeEntry898(io *wireIO, entry *protocol.BlockChangeEntry) {
...
func marshalStructureSettings898(io *wireIO, settings *protocol.StructureSettings) {
...
func marshalUpdateSubChunkBlocks(io *wireIO, raw packet.Packet) {
	...
	protocol.FuncIOSlice(io.directional(), &pk.Blocks, func(raw protocol.IO, entry *protocol.BlockChangeEntry) {
		marshalBlockChangeEntry898(asWireIO(raw), entry)
	})
