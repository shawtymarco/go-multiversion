// Package v1_18_0 implements Minecraft Bedrock protocol 475 for stable
// Minecraft 1.18.0 through 1.18.2 against the current native model.
package v1_18_0
...
// PreSpawnPackets restores the protocol-475 spawn order. The 1.18 client
...
// ReuseBiomePalettes reports that protocol 475 predates the 0xff marker used
