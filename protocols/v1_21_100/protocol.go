// Package v1_21_100 implements the Minecraft Bedrock 1.21.10x protocol 827
...
const (
	// ID is the Minecraft Bedrock 1.21.10x protocol ID.
	ID int32 = 827
	// Version is the newest stable Minecraft version in the protocol 827 family.
	Version = "1.21.102"
)

// Protocol implements minecraft.Protocol for stable Minecraft 1.21.100 through
// 1.21.102. Registry-aware consumers may advertise it after construction.
type Protocol struct {
	runtime *runtimeData
}

// MappingReport summarises the exact registries and explicit fallbacks used by
// a configured protocol-827 adapter.
...
// New creates a protocol 827 wire adapter.
func New() minecraft.Protocol { return &Protocol{} }

// NewWithBlockRegistry creates a fully configured protocol-827 adapter using
...
// MapBlockRuntimeID maps a current native runtime ID to the protocol-827
...
func (Protocol) Packets(listener bool) packet.Pool {
	...
	// Protocol 827 left packet ID 16 unused. Its server pool ended with the
	...
	// therefore absent. Protocol 827 predates ServerBoundPackSettingChange at
	// ID 329.
